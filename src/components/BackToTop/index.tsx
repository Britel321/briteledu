...
export const BackToTop: React.FC<BackToTopProps> = ({ className, threshold = 300 }) => {
    ...
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden rounded-full">
          <div
            className="absolute top-1 left-1/2 w-1 h-1 bg-white/60 rounded-full animate-bounce"
            style={{ animationDelay: '0s' }}
          />
          <div
            className="absolute top-2 left-1/3 w-0.5 h-0.5 bg-white/40 rounded-full animate-bounce"
            style={{ animationDelay: '0.5s' }}
          />
          <div
            className="absolute top-3 right-1/3 w-0.5 h-0.5 bg-white/40 rounded-full animate-bounce"
